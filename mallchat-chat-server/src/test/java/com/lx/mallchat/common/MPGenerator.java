...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/zongzibinbin\">lx</a>");
        ...
        packageConfig.setParent("com.lx.mallchat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3307/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}